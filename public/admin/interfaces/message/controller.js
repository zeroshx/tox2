  ...
  .controller('MessageCtrl', function($rootScope, $scope, $routeParams, $window, $anchorScroll, CRUDService, PublicService) {
      ...
      if ($scope.formMode === 'UPDATE' || $scope.formMode === 'VERIFY' ) {
        ...
        for (var i in $scope.docs) {
          if ($scope.docs[i]._id === id) {
            ...
            $scope.targetSenderUid = $scope.docs[i].sender.uid;
            $scope.targetSenderNick = $scope.docs[i].sender.nick;
            $scope.targetReceiverUid = $scope.docs[i].receiver.uid;
            $scope.targetReceiverNick = $scope.docs[i].receiver.nick;
    ...
    ****************************************************************************/
    $scope.Create = function() {
      CRUDService.Create($scope.baseUrl).run({
        senderUid: $scope.targetSenderUid,
        senderNick: $scope.targetSenderNick,
        receiverUid: $scope.targetReceiverUid,
        receiverNick: $scope.targetReceiverNick,
    ...
    ****************************************************************************/
    ...
    $scope.ResetTarget = function() {
      $scope.targetId = null;
      $scope.targetSenderUid = null;
      $scope.targetSenderNick = null;
      $scope.targetReceiverUid = null;
