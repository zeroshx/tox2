angular.module('TOX2ADMINAPP')
  .controller('DepositCtrl', function($rootScope, $scope, $routeParams, $filter, $window, $anchorScroll, CRUDService, PublicService) {

    /****************************************************************************
        Basic Vars setting
    ****************************************************************************/
    $scope.baseUrl = '/asset/deposit';
    ...
    ****************************************************************************/
    ...
    $scope.Cancel = function(id) {
      CRUDService.Update($scope.baseUrl + '/cancel', id).run({},
        function(res) {
          if (res.failure) {
            $scope.validator.type = 'error';
            $scope.validator.message = res.failure;
